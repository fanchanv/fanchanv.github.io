...
.brand{display:flex;align-items:center;justify-content:flex-start;text-align:center;color:#000;font-size:27px;font-weight:200;padding:20px;cursor:pointer}
.brand span{color:#fff;font-weight:600}
.brand span.flag{color:#00c250;background:#fff;border-radius:6px;font-size:15px;font-weight:700;display:inline-block;padding:0 5px;margin-left:5px}
...
<?php 
 $string = '["地址发布页","收藏或截屏本页，避免迷路","最新入口地址(点击跳转到随机临时域名)","記住永久地址(需翻墙访问)","发布页地址","点击这里进入本网站","联络邮件","希望大家能学会发送邮件获取新地址","以上地址无法访问请发送\"获取\"获取最新地址","推荐使用谷歌(Chrome)浏览器访问本站，谷歌浏览器速度更快，iPhone建议使用手机自带Safria浏览器访问","如果您记不住本站域名，请收藏该页地址,收藏并分享给好朋友","使用电脑的用户，请按键盘上的CTRL+D进行收藏","苹果手机用户在浏览器点击","然后添加到个人收藏或主屏幕","安卓手机用户点击","或者打开浏览器设置，添加到书签或主屏幕","se25.top","https://se25.top","https://fanchanv.com","https://se23.xyz","https://github.com/fanchanv/latest","fanchanv@proton.me"]';
 $encoded =  mb_convert_encoding($string, 'HTML-ENTITIES', 'UTF-8');
 $encodedText = json_decode($encoded, true);
/*
 $encodedText = mb_convert_encoding('地址发布页', 'HTML-ENTITIES', 'UTF-8');
 $encodedText2 = mb_convert_encoding('收藏或截屏本页，避免迷路', 'HTML-ENTITIES', 'UTF-8'); 
 $encodedText3 = mb_convert_encoding('最新入口地址(点击跳转到随机临时域名)', 'HTML-ENTITIES', 'UTF-8'); 
 $encodedText4 = mb_convert_encoding('永久地址(需翻墙访问)', 'HTML-ENTITIES', 'UTF-8'); 
 $encodedText5 = mb_convert_encoding('发布页地址', 'HTML-ENTITIES', 'UTF-8'); 
 */
 
 ?>
<title>最新<?php echo $encodedText[0];?></title>
</head>
<body>

<div id="main">
<div class="brand" id="logo">
<span><?php echo $encodedText[0];?>
</span><span class="flag"><?php echo $encodedText[1];?></span>
</div>
<div class="field">
...
<a href="<?php echo $encodedText[17];?>"><span class="c_blue"><?php echo $encodedText[5];?> (<?php echo $encodedText[16];?>)</span> </a>
</div>
</div>
<p class="c_blue c_link"><?php echo $encodedText[2];?>：</p>
<p class="c_blue c_link"><a href="<?php echo $encodedText[17];?>" target="_blank"><?php echo $encodedText[17];?></a></p>
</div>
<div class="field ">
<h4 class="title">✈ <?php echo $encodedText[3];?></h4>
<ul>
<li><a href="<?php echo $encodedText[18];?>" target="_blank"><?php echo $encodedText[18];?></a></li>
</ul>
</div>
<div class="field ">
<h4 class="title">🖤<?php echo $encodedText[4];?></h4>
<ul>
<li><a href="<?php echo $encodedText[19];?>" target="_blank"><?php echo $encodedText[19];?></a></li>
<li><a href="<?php echo $encodedText[20];?>" target="_blank"><?php echo $encodedText[20];?></a></li>
</ul>
</div>
<div class="field ">
<h4 class="title">✉ <?php echo $encodedText[6];?></h4>
<ul>
<li><a><?php echo $encodedText[21];?></a></li>
</ul>
<ul>
<li><a><?php echo $encodedText[7];?></a></li>
<li><a>（<?php echo $encodedText[8];?>）</a></li>
</ul>
</div>
...
<ul>
<li>* <?php echo $encodedText[9];?>。</li>
<li>* <?php echo $encodedText[10];?>。</li>
<p class="c_black">1、<?php echo $encodedText[11];?></p>
<p class="c_black">2、<?php echo $encodedText[12];?><span class="icon icon_ios_shared small-img"></span>，<?php echo $encodedText[13];?>。</p>
<p class="c_black">3、<?php echo $encodedText[14];?><span class="icon icon_android_share small-img"></span>，<?php echo $encodedText[15];?>。</p>
</ul>
</div>
</div>
</body>
